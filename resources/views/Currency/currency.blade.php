...
<head>
    ...
    <script src="{{ asset('js/jquery3.5.1.js') }}" defer></script>
</head>
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="currency-exchange-rate" action="#" method="post" class="form-group">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <input type="text" name="amount" class="form-control" value={{$price}} >
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <input name="to_currency" class="form-control" value="USD">
